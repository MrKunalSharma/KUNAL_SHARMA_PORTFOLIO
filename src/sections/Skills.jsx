...
const skillCategories = [
  {
    ...
    skills: ["Machine Learning", "Neural Networks", "Classification", "Regression", "Feature Engineering", "TensorFlow", "Keras", "Scikit-learn"]
  },
  {
    title: "Advanced AI Applications",
    icon: <FaRobot className="text-2xl" />,
    gradient: "from-blue-600 to-indigo-600", 
    skills: ["Computer Vision", "YOLOv8", "OpenCV", "NLP", "RAG Systems", "LLMs", "LoRA Fine-Tuning", "LangChain"]
  },
  {
    title: "MLOps & Deployment",
    icon: <FaCloud className="text-2xl" />,
    gradient: "from-cyan-600 to-teal-600",
    skills: ["MLOps", "Model Deployment", "Prometheus Monitoring", "A/B Testing", "Drift Detection", "Docker", "Kubernetes", "Cloud Deployment"]
  },
  {
    title: "Data Engineering",
    icon: <FaDatabase className="text-2xl" />,
    gradient: "from-green-600 to-teal-600",
    skills: ["Data Preprocessing", "NumPy", "Pandas", "Vector Databases", "ChromaDB", "PostgreSQL", "Query Optimization", "Data Analysis"]
  },
  {
    title: "Programming",
    icon: <FaCode className="text-2xl" />,
    gradient: "from-blue-600 to-indigo-600",
    skills: ["Python", "C++", "JavaScript", "SQL", "HTML", "CSS", "API Integration", "Performance Optimization"]
  },
  {
    title: "DevOps & Tools",
    icon: <FaTools className="text-2xl" />,
    gradient: "from-amber-500 to-orange-600",
    skills: ["Git", "GitHub", "VS Code", "Jupyter", "FastAPI", "REST APIs", "Streamlit", "Google Cloud"]
  }
];
...
const Skills = () => {
        ...
        competitions.forEach(comp => {
          ...
          if (current < comp.rating) {
            ...
            setCountedRatings(prev => ({
              ...prev,
              [comp.name]: Math.min(current + Math.ceil(comp.rating / 30), comp.rating)
            }));
          }
        });
  ...
  return (
    <section id="skills" ref={skillsRef} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {skillCategories.map((category, catIndex) => (
            ...
            >
              {/* Background gradient */}
              <div className="absolute inset-0 bg-gradient-to-br opacity-5 z-0 rounded-xl transition-opacity duration-300 hover:opacity-10" 
                  ...
                  {category.skills.map((skill, skillIndex) => (
                    <div
                      ...
                      className={`group/skill flex flex-col items-center justify-center p-3 sm:p-4 rounded-lg relative cursor-pointer overflow-hidden transition-all duration-300 aspect-square
                                  ${selectedSkill === skill ? 'ring-2 ring-indigo-500 shadow-lg shadow-indigo-500/20' : 'hover:shadow-lg'}
                    ...
                    >
                      <div className="relative z-10 flex flex-col items-center justify-center h-full w-full">
                        <div 
                          className="text-2xl sm:text-3xl mb-1 sm:mb-2 transform transition-transform duration-300 group-hover/skill:scale-110"
                        >
                          {skillIcons[skill] || <FaCode className="text-gray-400" />}
                        </div>
                        <p className="text-gray-300 text-xs font-medium text-center group-hover/skill:text-white transition-colors duration-300 line-clamp-1">
                          {skill}
                        </p>
              ...
              >
                ...
                <div className="relative card backdrop-blur-sm border border-indigo-800/20 rounded-xl overflow-hidden transition-all duration-300 bg-gray-900/60 h-full">
                  ...
                  <div className="absolute -right-12 -top-12 w-24 sm:w-32 h-24 sm:h-32 opacity-5 group-hover:opacity-10 transition-opacity duration-300 pointer-events-none">
                    {React.cloneElement(comp.icon, { className: "w-full h-full" })}
                  </div>
                  ...
                  <div className="p-4 sm:p-6 relative z-10 h-full flex flex-col">
                    <div className="flex items-center mb-2 sm:mb-3">
                      ...
                      <h4 className="text-base sm:text-lg font-bold text-white">{comp.name}</h4>
                    </div>
